...
@Value
public class Schedule2 implements Iterable<ScheduledTask> {

    private static final int PROCESSOR_NUM = 0;
    private static final int START_TIME = 1;
    private static final int FINISH_TIME = 2;

    private static final Schedule2 EMPTY = new Schedule2();
    ...
    public Schedule2(@NonNull Schedule2 parent, @NonNull ScheduledTask scheduledTask) {
        this.parent = parent;
        this.scheduledTask = scheduledTask;
        this.depth = parent.getDepth() + 1;
    }

    public static Schedule2 empty() {
        return EMPTY;
    }
    ...
    public Set<Schedule2> expand(SchedulingContext context) {
        Set<Schedule2> output = new HashSet<>();
        ...
        for(val node : context.getTaskGraph().getNodes()) {
            ...
            for(int i = 0; i < context.getProcessorCount(); ++i) {
                ...
                output.add(new Schedule2(this, new ScheduledTask(i, startTime, node)));
            }
     ...
     */
    private Schedule2 findPartialScheduleFor(Node node) {
        var sched = this;
        while(!sched.isEmpty()) {
    ...
    public Iterator<ScheduledTask> iterator() {
        return new Iterator<ScheduledTask>() {
            private Schedule2 current = Schedule2.this;
